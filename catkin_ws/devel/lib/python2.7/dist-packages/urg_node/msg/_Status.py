...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2HBHBHf.pack(_x.operating_mode, _x.area_number, _x.error_status, _x.error_code, _x.lockout_status, _x.distance, _x.angle))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.operating_mode, _x.area_number, _x.error_status, _x.error_code, _x.lockout_status, _x.distance, _x.angle,) = _struct_2HBHBHf.unpack(str[start:end])
