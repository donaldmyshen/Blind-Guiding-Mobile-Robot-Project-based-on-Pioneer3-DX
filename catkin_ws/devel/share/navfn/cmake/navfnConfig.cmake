...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/hunter/catkin_ws/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/hunter/catkin_ws/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/hunter/catkin_ws/install)
...
if(NOT "/home/hunter/catkin_ws/devel/include;/home/hunter/catkin_ws/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/hunter/catkin_ws/devel/include;/home/hunter/catkin_ws/src/navigation/navfn/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hunter/catkin_ws/src/navigation/navfn/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>, Aaron Hoy <ahoy@fetchrobotics.com>' to fix it.")
    endif()
